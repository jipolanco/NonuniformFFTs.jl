...
The script used for benchmarking can be found in [`benchmark/benchmarks.jl`](https://github.com/jipolanco/NonuniformFFTs.jl/blob/master/benchmark/benchmarks.jl).
