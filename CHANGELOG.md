...
- Support backend-based AbstractNFFTs interface (introduced in AbstractNFFTs.jl v0.9).
...
- Allow user-defined callbacks, which can be used to modify input and/or output transform
  ...
  certain applications, as it allows to combine operations and to avoid the allocation of
  extra arrays.
